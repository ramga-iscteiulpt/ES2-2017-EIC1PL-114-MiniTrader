...
//        xmlSaver = new XMLSaver(new File("OrdersPersistence.xml"));
     ...
     * @throws ServerException exception thrown by the server indicating that the user is not connected
     */
     ...
     *
     * @param msg the message sent by the client
     * @throws ServerException exception thrown by the server indicating that the user is already connected
     */
     ...
     *
     * @param sellOrder Order sent by the client with a number of units of a stock and the price per unit he wants to sell
     */
     ...
     *
     * @throws ServerException exception thrown in the method notifyAllClients, in case there's no order
     */
     ...
     * @throws ServerException exception thrown by the server indicating that there is no order
     */
